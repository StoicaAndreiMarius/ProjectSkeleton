...
/// <summary>
/// Translation-only camera that converts between world and screen coordinates
/// and clamps itself so it never pans past the edges of the world.
/// </summary>
public class Camera
{
    private int _x;
    ...
    public void SetWorldBounds(Rectangle<int> bounds)
    {
        ...
        _worldBounds = new Rectangle<int>(marginLeft, marginTop,
            bounds.Size.X - marginLeft * 2, bounds.Size.Y - marginTop * 2);
    ...
    {
        return rect.GetTranslated(new Vector2D<int>(Width / 2 - _x, Height / 2 - _y));
    }
